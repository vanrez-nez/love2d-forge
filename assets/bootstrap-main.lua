...
local WORKSPACE = "__WORKSPACE_PATH__"
...
package.path = PROJECT .. "/?.lua;" .. PROJECT .. "/?/init.lua;" .. WORKSPACE .. "/?.lua;" .. WORKSPACE .. "/?/init.lua;" .. package.path
...
_G.__LOVE2D_WORKSPACE_PATH = WORKSPACE
